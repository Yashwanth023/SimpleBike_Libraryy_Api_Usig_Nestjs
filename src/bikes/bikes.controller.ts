...
export class BikesController {
  ...
  @ApiResponse({ status: 201, description: 'The bike has been successfully created.', type: Bike })
  ...
  @ApiResponse({ status: 200, description: 'The bike has been successfully updated.', type: Bike })
  @ApiResponse({ status: 404, description: 'Bike not found.' })
  ...
  @ApiResponse({ status: 200, description: 'The bike has been successfully deleted.' })
  @ApiResponse({ status: 404, description: 'Bike not found.' })
